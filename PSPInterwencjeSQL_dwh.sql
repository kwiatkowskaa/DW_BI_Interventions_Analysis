...
CREATE TABLE DIM_LOKALIZACJA (
  LOKALIZACJA_KEY INT identity(1,1) PRIMARY KEY NOT NULL,
  WOJEWODZTWO VARCHAR(100) ,
  POWIAT VARCHAR(100) ,
  GMINA VARCHAR(100) ,
  RODZAJ_GMINY VARCHAR(100) ,
  KOD_POCZTOWY VARCHAR(10) ,
  NAZWA_KOMENDY_WOJEWODZKIEJ VARCHAR(400) ,
  NAZWA_KOMENDY_POWIATOWEJ VARCHAR(400) 
);
...
CREATE TABLE DIM_CZAS (
  CZAS_KEY INT identity(1,1) PRIMARY KEY NOT NULL,
  DATE DATE NOT NULL,
